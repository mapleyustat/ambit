...
/*
 This is the ideal version of close-shell CCSD, directly coded based on the equations.
 The G tensor is not sliced and the operations are contracted in few steps.
